...
| Side Inspection PC 분리 (PC1: Top/Bottom, PC2: Side) — 2026-05-08 | 물리적 독립 배포, 동일 SW 인스턴스, 각자 TCP로 제어팀에 결과 전송 | — Pending (v1.1 Phase 27) |
| LineToLineAngle 알고리즘 신규 추가 (Phase 27) — 2026-05-08 | D1/H5 각도 측정 대응, Back light 2D | — Pending (v1.1 Phase 27) |
| Side Fixture Datum = TwoLineIntersect 재사용 — 2026-05-08 | 교점 계산만 필요, Plane C/D는 OMM 전용 절차로 2D 비전 무관 | — Pending (v1.1 Phase 27) |
