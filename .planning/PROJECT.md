...
- [ ] 제어 프로토콜 v2.7 — TCP/IP 신규 통신 사양
  - TEST 커맨드: `$TEST:site,null,z_index@` (z_index 파라미터 추가)
  - RESULT 포맷: `$RESULT:site;P|F|B;count;id=val=OK,...@` (;/,/= 3단 구분자)
...
## Current Milestone: v1.2 POC Workflow + Output + Carry-over + Protocol v2.7
...
---
*Last updated: 2026-05-29 — **v1.2 milestone started** (POC 6월 말 기준 5순위 우선순위 확정, Phase 39부터 continue numbering). 다음 = /gsd-plan-phase 39 (WF-01/02).*
