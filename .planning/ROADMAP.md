...
- [⚠] **Phase 36: Datum DualImage 설계 보강** — PARTIAL signed_off 2026-05-28 (4 plan 코드 머지 + msbuild PASS + guard 4파일 0; 시각화 root cause "purple" 무효색 해소 fec1e02; Test 2~7 시각 UAT 잔여=CO-36-05; CO-36-01 수직도 필드화 open; Side 4-datum 요구 발견 → Phase 37 신설)
