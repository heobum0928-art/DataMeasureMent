...
Last activity: 2026-08-05 - Quick 260805-jtj 완료: CAM_BOTTOM MilCamera 공유 시 REVERSE_X_BOTTOM 미반영 버그 수정(역할별 DeviceInfo 재적용). 빌드 PASS, 실HW 검증은 carry-over(이 PC 는 CXP 보드 없는 SIMUL 전용 랩탑). 이전: 엑셀 출력 이미지 삽입 2건(260805-d9y/260805-e1l) 사용자 실기 승인 완료. 260805-f3w(흐름 로그 신설+strip 스팸 정리) 계획만 커밋, 실행은 보류(사용자 결정 2026-08-05)
