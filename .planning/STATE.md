...
Last activity: 2026-08-05 - 엑셀 출력 이미지 삽입 2건(260805-d9y 일반검사 K열 캡쳐이미지, 260805-e1l 일괄검사 ExportBatch 회차별 상세+이미지) 사용자 실기 승인 완료. 260805-f3w(흐름 로그 신설+strip 스팸 정리) 계획만 커밋, 실행은 보류(사용자 결정 2026-08-05)
