...
Last activity: 2026-07-29 - Completed quick task 260729-e7v: GetAnyInspectionSequence() 호출부 3곳을 role-aware GetInspectionSequenceForDatum(datum) 으로 교체 (260728-n7b 후속 구조 하드닝, 활성 버그는 없었음)
