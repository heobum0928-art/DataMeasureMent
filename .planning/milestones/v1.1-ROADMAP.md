# v1.1 Roadmap (ARCHIVED) — Quality + Workflow + Algorithm

> **Status:** Shipped 2026-05-28. 17 phases executed (18~38 + inserts 23.1/34.1).
> Quality(QUAL-02/03/04) + Buffer(BUF) + Image-dual(IMG) + Algorithm/Datum 대거 확장 완료.
> WF/OUT/HW/QUAL-01 → v1.2 이연. 부분: ALG-01(CO-23-01).
> Audit: [v1.1-MILESTONE-AUDIT.md](../v1.1-MILESTONE-AUDIT.md). 아래는 종결 시점 ROADMAP 전문 보존.

---

# Roadmap: DataMeasurement (v1.1 종결 스냅샷)
