...
namespace ReringProject.Sequence {
    ...
    public class BottomCalibrationParam : CameraSlaveParam {
        ...
        [Spinnable(1, 2, 1, 10)]
        [DisplayName("Display Picker Num"), ReadOnly(true)]
        ...
        //public enum PickerNum { Picker_0 = 0, Picker_1 = 1, Picker_2 = 2, Picker_3, Picker_4, Picker_5, Picker_6, Picker_7, Picker_8, Picker_9};
        public enum PickerNum { Picker_1 = 1, Picker_2 = 2, Picker_3, Picker_4, Picker_5, Picker_6, Picker_7, Picker_8, Picker_9, Picker_10 };
        [Category("Picker Selection")]

        [DisplayName("World Calibration")]
        ...
        [ReadOnly(true)]
        public double X_Picker_10
        {
            get { return _X_Picker_10; }
            set
            {
                _X_Picker_10 = value;
                RaisePropertyChanged("X_Picker_10");
            }
        }
        private double _X_Picker_10;
        ...
        [ReadOnly(true)]
        public double Y_Picker_10
        {
            get { return _Y_Picker_10; }
            set
            {
                _Y_Picker_10 = value;
                RaisePropertyChanged("Y_Picker_10");
            }
        }
        private double _Y_Picker_10;
    ...
    class CalImageProcessor
    {
        ...
        public bool CalibrationImage(int ImageGrabIndex, Mat ImageBuffer, BottomCalibrationContext pMyContext, BottomCalibrationParam pMyParam)
        {
            ...
            if(ImageGrabIndex == (10 - pMyParam.Display_Picker_Num))
            {
                pMyContext.ResultImage = ImageBuffer.Clone();
                pMyContext.PickerNum = 10 - pMyParam.Display_Picker_Num;
            }
            ...
            else
            {
                ...
                switch (ImageGrabIndex)
                {
                    case 0:
                        ...
                        {
                            pMyParam.X_Picker_10 = pMyContext.CenterOffsetXmm[ImageGrabIndex];
                            pMyParam.Y_Picker_10 = pMyContext.CenterOffsetYmm[ImageGrabIndex];
                        }
                        else
                        {
                            pMyParam.X_Picker_10 = pMyContext.CircleResult.dXPos[0];
                            pMyParam.Y_Picker_10 = pMyContext.CircleResult.dYPos[0];
                        }
                        break;
                    case 1:
                        if (pMyParam.WorldCalibration)
    ...
    public class BottomCalibrationAction : ActionBase {
        ...
        //HW multi trigger
        private int ImageGrabIndex = 0;    // 0
            ...
            switch ((EStep)Step) {
                ...
                case EStep.End:
                    ...
                    if (pMyParam.DebugCheck)    // 개별 이미지를 이용해 Calibration 진행시 사용.
                    {
                        ...
                        {
                            case BottomCalibrationParam.PickerNum.Picker_10:
                                pMyParam.X_Picker[0] = pMyContext.X_Picker[0] = pMyParam.X_Picker_10 = pMyParam.BaseX = pMyContext.CircleCenter_X[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dXPos[0];
                                pMyParam.Y_Picker[0] = pMyContext.Y_Picker[0] = pMyParam.Y_Picker_10 = pMyParam.BaseY = pMyContext.CircleCenter_Y[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dYPos[0];

                                if (pMyParam.WorldCalibration)
                                {
                                    pMyParam.X_Picker_10 = pMyContext.CenterOffsetXmm[0];
                                    pMyParam.Y_Picker_10 = pMyContext.CenterOffsetYmm[0];
                                }

                                break;
                            case BottomCalibrationParam.PickerNum.Picker_9:
                                pMyParam.X_Picker[1] = pMyContext.X_Picker[1] = pMyParam.X_Picker_9 = pMyParam.BaseX = pMyContext.CircleCenter_X[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dXPos[0];
                                pMyParam.Y_Picker[1] = pMyContext.Y_Picker[1] = pMyParam.Y_Picker_9 = pMyParam.BaseY = pMyContext.CircleCenter_Y[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dYPos[0];

                                if (pMyParam.WorldCalibration)
                                {
                                    pMyParam.X_Picker_9 = pMyContext.CenterOffsetXmm[1];
                                    pMyParam.Y_Picker_9 = pMyContext.CenterOffsetYmm[1];
                                }

                                break;
                            case BottomCalibrationParam.PickerNum.Picker_8:
                                pMyParam.X_Picker[2] = pMyContext.X_Picker[2] = pMyParam.X_Picker_8 = pMyParam.BaseX = pMyContext.CircleCenter_X[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dXPos[0];
                                pMyParam.Y_Picker[2] = pMyContext.Y_Picker[2] = pMyParam.Y_Picker_8 = pMyParam.BaseY = pMyContext.CircleCenter_Y[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dYPos[0];

                                if (pMyParam.WorldCalibration)
                                {
                                    pMyParam.X_Picker_8 = pMyContext.CenterOffsetXmm[2];
                                    pMyParam.Y_Picker_8 = pMyContext.CenterOffsetYmm[2];
                                }

                                break;
                            case BottomCalibrationParam.PickerNum.Picker_7:
                                pMyParam.X_Picker[3] = pMyContext.X_Picker[3] = pMyParam.X_Picker_7 = pMyParam.BaseX = pMyContext.CircleCenter_X[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dXPos[0];
                                pMyParam.Y_Picker[3] = pMyContext.Y_Picker[3] = pMyParam.Y_Picker_7 = pMyParam.BaseY = pMyContext.CircleCenter_Y[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dYPos[0];

                                if (pMyParam.WorldCalibration)
                                {
                                    pMyParam.X_Picker_7 = pMyContext.CenterOffsetXmm[3];
                                    pMyParam.Y_Picker_7 = pMyContext.CenterOffsetYmm[3];
                                }

                                break;
                            case BottomCalibrationParam.PickerNum.Picker_6:
                                pMyParam.X_Picker[4] = pMyContext.X_Picker[4] = pMyParam.X_Picker_6 = pMyParam.BaseX = pMyContext.CircleCenter_X[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dXPos[0];
                                pMyParam.Y_Picker[4] = pMyContext.Y_Picker[4] = pMyParam.Y_Picker_6 = pMyParam.BaseY = pMyContext.CircleCenter_Y[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dYPos[0];

                                if (pMyParam.WorldCalibration)
                                {
                                    pMyParam.X_Picker_6 = pMyContext.CenterOffsetXmm[4];
                                    pMyParam.Y_Picker_6 = pMyContext.CenterOffsetYmm[4];
                                }
                            ...
                            case BottomCalibrationParam.PickerNum.Picker_4:
                                pMyParam.X_Picker[6] = pMyContext.X_Picker[6] = pMyParam.X_Picker_4 = pMyParam.BaseX = pMyContext.CircleCenter_X[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dXPos[0];
                                pMyParam.Y_Picker[6] = pMyContext.Y_Picker[6] = pMyParam.Y_Picker_4 = pMyParam.BaseY = pMyContext.CircleCenter_Y[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dYPos[0];

                                if (pMyParam.WorldCalibration)
                                {
                                    pMyParam.X_Picker_4 = pMyContext.CenterOffsetXmm[6];
                                    pMyParam.Y_Picker_4 = pMyContext.CenterOffsetYmm[6];
                                }

                                break;
                            case BottomCalibrationParam.PickerNum.Picker_3:
                                pMyParam.X_Picker[7] = pMyContext.X_Picker[7] = pMyParam.X_Picker_3 = pMyParam.BaseX = pMyContext.CircleCenter_X[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dXPos[0];
                                pMyParam.Y_Picker[7] = pMyContext.Y_Picker[7] = pMyParam.Y_Picker_3 = pMyParam.BaseY = pMyContext.CircleCenter_Y[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dYPos[0];

                                if (pMyParam.WorldCalibration)
                                {
                                    pMyParam.X_Picker_3 = pMyContext.CenterOffsetXmm[7];
                                    pMyParam.Y_Picker_3 = pMyContext.CenterOffsetYmm[7];
                                }

                                break;
                            case BottomCalibrationParam.PickerNum.Picker_2:
                                pMyParam.X_Picker[8] = pMyContext.X_Picker[8] = pMyParam.X_Picker_2 = pMyParam.BaseX = pMyContext.CircleCenter_X[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dXPos[0];
                                pMyParam.Y_Picker[8] = pMyContext.Y_Picker[8] = pMyParam.Y_Picker_2 = pMyParam.BaseY = pMyContext.CircleCenter_Y[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dYPos[0];

                                if (pMyParam.WorldCalibration)
                                {
                                    pMyParam.X_Picker_2 = pMyContext.CenterOffsetXmm[8];
                                    pMyParam.Y_Picker_2 = pMyContext.CenterOffsetYmm[8];
                                }
                                break;
                            case BottomCalibrationParam.PickerNum.Picker_1:
                                pMyParam.X_Picker[9] = pMyContext.X_Picker[9] = pMyParam.X_Picker_1 = pMyParam.BaseX = pMyContext.CircleCenter_X[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dXPos[0];
                                pMyParam.Y_Picker[9] = pMyContext.Y_Picker[9] = pMyParam.Y_Picker_1 = pMyParam.BaseY = pMyContext.CircleCenter_Y[(int)pMyParam.CalbrationPicker] = pMyContext.CircleResult.dYPos[0];

                                if (pMyParam.WorldCalibration)
                                {
                                    pMyParam.X_Picker_1 = pMyContext.CenterOffsetXmm[9];
                                    pMyParam.Y_Picker_1 = pMyContext.CenterOffsetYmm[9];
                                }
