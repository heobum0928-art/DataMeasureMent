//260519 hbk Phase 31 D-11 — E9: 다단계 기하 체인(CL2/CL3 + La/Lb) → Datum C X 거리
...
namespace ReringProject.Sequence
{
    ...
    /// → Pc=midpoint(Pa,Pb) → ComputeProjectionDistance(Pc, DatumC).
    /// E9(SOP): CompoundCenterCDistance — 기하 체인으로 Pc 산출 후 Datum C X 방향 거리(mm).
    /// CL1 없음 (E2 와 달리 Pd 불필요 — D-11 타입 분리).
    /// D-09: 중간 산출물 내부 계산, D-07: MeasureAxis 기본값 "X" (Datum C X 방향).
    /// </summary>
    public class CompoundCenterCDistanceMeasurement : MeasurementBase, IDatumOriginConsumer //260519 hbk Phase 31 D-11
    {
        public override string TypeName { get { return "CompoundCenterCDistance"; } } //260519 hbk Phase 31 D-11
        ...
        // ── MeasureAxis ───────────────────────────────────────────────────────────────
        //260519 hbk Phase 31 D-11 — E9 = Datum C X 방향이므로 기본값 "X" (D-07/D-08 확정)
        [Category("Edge")] //260519 hbk Phase 31 D-11
        [ItemsSourceProperty(nameof(MeasureAxisList))] //260519 hbk Phase 31 D-11
        public string MeasureAxis { get; set; } = "X"; //260519 hbk Phase 31 D-11 (E9 = Datum C X 방향)
        [PropertyTools.DataAnnotations.Browsable(false)] //260519 hbk Phase 31 D-11
        public List<string> MeasureAxisList { get { return new List<string> { "X", "Y" }; } } //260519 hbk Phase 31 D-11
        ...
        public CompoundCenterCDistanceMeasurement(object owner) : base(owner) { } //260519 hbk Phase 31 D-11
            ...
            out List<EdgeInspectionOverlay> overlays)
        {
            ...
            // Pc → Datum C X 방향 거리(mm)
            //260519 hbk Phase 31 D-04 — ComputeProjectionDistance 공용 헬퍼 호출 (D-07: E9 = Datum C X 거리)
