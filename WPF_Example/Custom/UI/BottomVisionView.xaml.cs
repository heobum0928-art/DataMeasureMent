    ...
    public partial class BottomVisionView : UserControl {
        ...
        private void LiveButton_Click(object sender, RoutedEventArgs e) {
            ...
            try {
                ...
                if (bOk) {
                    btn_live.Content = "Live On";   //260724 hbk 버튼 자체 글자 토글
        ...
        private bool ApplyTeachParams(bool bAskOnChange) {
            ...
            if (bAskOnChange == true) {
                AlignRefPose saved = EthernetVisionHandler.Handle.Matcher.GetSlotRefPose(VIEW_MODE, _selectedSlot);
                if (saved != null) {
        ...
        private void RunButton_Click(object sender, RoutedEventArgs e) {
            ...
            try {
                ...
                SystemHandler.Handle.RecordAlignVerifyManual(
                    VIEW_MODE, _selectedSlot, _viewer.CurrentImage, res, res.Found);
